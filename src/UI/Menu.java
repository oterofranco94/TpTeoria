...
public class Menu extends javax.swing.JFrame {
    ...
    public Vector<Imagen> imagenes4 = new Vector<Imagen>();
   
    public boolean accesoEjer2=false;
    
    public Menu(Vector<Imagen> imagenes1, Vector<Imagen> imagenes2, Vector<Imagen> imagenes3, Vector<Imagen> imagenes4) {
        initComponents();     
        this.imagenes1=imagenes1;
        this.imagenes2=imagenes2;
        this.imagenes3=imagenes3;
        this.imagenes4=imagenes4;
    }
    ...
    try {
        Ejercicio3 dialog = new Ejercicio3(new javax.swing.JFrame(), true, imagenes3 );
        dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        dialog.setVisible(true);
    } catch (Exception ex) {
        ex.printStackTrace();
    ...
    try {
        Ejercicio4 dialog = new Ejercicio4(new javax.swing.JFrame(), true, imagenes4 );
        dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        dialog.setVisible(true);
    } catch (Exception ex) {
        ex.printStackTrace();
