...
public class Ejercicio3 extends javax.swing.JFrame {
    ...
    String archivo2 = "../TpTeoInfo/generados/comprimidoOriginal.txt";
    ...
    String archivo4 = "../TpTeoInfo/generados/comprimidoMasParecido.txt";
    ...
    String archivo6 = "../TpTeoInfo/generados/comprimidoImgPolicia1.txt";
    long longitud6 = new File(archivo6).length();
    lista.add(Double.valueOf(longitud6));
    
    String archivo7 = "../TpTeoInfo/generados/comprimidoImgPolicia2.txt";
